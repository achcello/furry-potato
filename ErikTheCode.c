...
#pragma config(Motor,  port8,           DLF,            tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           DLR,            tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           DRF,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           DRR,            tmotorVex393_MC29, openLoop)
...
task driveUserControl ()
{
	...
	while (true)
	{
		...
		motor[DLF] = motorLDriveUserOutput;
		motor[DLR] = motorLDriveUserOutput;
		motor[DRF] = motorRDriveUserOutput;
		motor[DRR] = motorRDriveUserOutput;
